...
# Specify "modifier_type": "2D" or "3D". For 3D modifiers you can include "r_eff_scale" (default 1.0).
modifier_defs = [
...
def compute_multiplier_for_modifier(x, y, z, mod):
    ...
    if mod["modifier_type"] == "2D":
        ...
        # For 3D modifiers, compute effective influence using a spherical model.
        if z < cz - mod["r_max"] or z > cz + mod["r_max"]:
            return 1.0
        # Compute effective XY radius at this z layer.
...
# Plot modifiers.
z_ref = min(zs)  # Use the minimum Z of the toolpath as a reference.
for mod in modifiers:
    if mod.get("modifier_type", "2D") == "2D":
        ...
        # Plot the full mesh as a wireframe.
        ...
        # Also, plot the effective XY circle at the reference Z.
        cx, cy, cz = mod["centroid_3d"]
